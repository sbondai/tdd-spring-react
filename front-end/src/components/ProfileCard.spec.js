...
describe("ProfileCard", () => {
  describe("Layout", () => {
    it("displays the displyName@username", () => {
    ...
    it("displays dispayName input when inEditMode property set to true", () => {
    ...
    it("hides the displyName@username in edit mode", () => {
      const { queryByText } = render(
        <ProfileCard user={user} inEditMode={true} />
      );
      const userInfo = queryByText("display1@user1");
    ...
    it("diplays label for displayName in edit mode", () => {
      const { container } = render(
        <ProfileCard user={user} inEditMode={true} />
      );
    ...
    it("displays Save button in edit mode", () => {
      const { queryByText } = render(
        <ProfileCard user={user} isEditable={true} inEditMode={true} />
      );
