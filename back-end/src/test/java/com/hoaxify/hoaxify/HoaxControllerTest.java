...
import com.hoaxify.hoaxify.hoax.service.HoaxService;
...
public class HoaxControllerTest {
	...
	@Test
	public void postHoax_whenHoaxHasFileAttachmentAndUserIsAuthorized_fileAttachmentHoaxRelationIsUpdatedInDatabase()
			throws IOException {
	...
	@Test
	public void postHoax_whenHoaxHasFileAttachmentAndUserIsAuthorized_hoaxFileAttachmentRelationIsUpdatedInDatabase()
			throws IOException {
		userService.save(TestUtil.createValidUser("user1"));
		authenticate("user1");
	...
	@Test
	public void postHoax_whenHoaxHasFileAttachmentAndUserIsAuthorized_receiveHoaxVMWithAttchment() throws IOException {
		userService.save(TestUtil.createValidUser("user1"));
		authenticate("user1");
	...
	@Test
	public void postHoax_whenHoaxIsValidAndUserIsAuthorized_hoaxIsSavedToDatabase() {
		userService.save(TestUtil.createValidUser("user1"));
		authenticate("user1");
		Hoax hoax = TestUtil.createValidHoax();
	...
	@Test
	public void postHoax_whenHoaxIsValidAndUserIsAuthorized_hoaxIsSavedToDatabaseWithTimestamp() {
		userService.save(TestUtil.createValidUser("user1"));
		authenticate("user1");
		Hoax hoax = TestUtil.createValidHoax();
		postHoax(hoax, Object.class);
	...
	@Test
	public void postHoax_whenHoaxContentIsNullAndUserIsAuthorized_receiveApiErrorValidationErrors() {
		userService.save(TestUtil.createValidUser("user1"));
		authenticate("user1");
		Hoax hoax = new Hoax();
	...
	@Test
	public void postHoax_whenHoaxIsValidAndUserIsAuthorized_hoaxIsSavedWithAuthenticatedUserInfo() {
		userService.save(TestUtil.createValidUser("user1"));
		authenticate("user1");
		Hoax hoax = TestUtil.createValidHoax();
		postHoax(hoax, Object.class);
	...
	public void getHoaxesOfUser_whenUserExists_receivePageWithZeroHoaxes() {
		userService.save(TestUtil.createValidUser("user1"));
		ResponseEntity<TestPage<Object>> response = getHoaxesOfUser("user1",
	...
	@Test
	public void getHoaxOfUser_whenUserExistWithHoax_receivePageWithHoaxVM() {
		User user = userService.save(TestUtil.createValidUser("user1"));
		hoaxService.save(user, TestUtil.createValidHoax());

		ResponseEntity<TestPage<HoaxVM>> response = getHoaxesOfUser("user1",
	...
	@Test
	public void getHoaxOfUser_whenUserExistWithMultipleHoax_receivePageWithMatchingHoaxesCount() {
		User user = userService.save(TestUtil.createValidUser("user1"));
		hoaxService.save(user, TestUtil.createValidHoax());
		hoaxService.save(user, TestUtil.createValidHoax());
		hoaxService.save(user, TestUtil.createValidHoax());
	...
	@Test
	public void getHoaxOfUser_whenMultipleUsersExistWithMultipleHoax_receivePageWithMatchingHoaxesCount() {
	...
	@Test
	public void getOldHoaxes_whenThereNoHoaxes_receiveOk() {
	...
	public void getOldHoaxes_whenThereAreHoaxes_receivePageWithItemsProvidedId() {
		...
		hoaxService.save(user, TestUtil.createValidHoax());
		hoaxService.save(user, TestUtil.createValidHoax());
		Hoax fourthHoax = hoaxService.save(user, TestUtil.createValidHoax());
		hoaxService.save(user, TestUtil.createValidHoax());

		ResponseEntity<TestPage<Object>> response = getOldHoaxes(fourthHoax.getId(),
				new ParameterizedTypeReference<TestPage<Object>>() {
				});
	...
	public void getOldHoaxes_whenThereAreHoaxes_receivePageWithHoaxVMBeforeProvidedId() {
		...
		ResponseEntity<TestPage<HoaxVM>> response = getOldHoaxes(fourthHoax.getId(),
				new ParameterizedTypeReference<TestPage<HoaxVM>>() {
				});
	...
	public void getOldHoaxesOfUser_whenUserExistAndThereAreHoaxes_receivePageWithItemsProvidedId() {
		...
		ResponseEntity<TestPage<Object>> response = getOldHoaxesOfUser(fourthHoax.getId(), "user1",
				new ParameterizedTypeReference<TestPage<Object>>() {
				});
	...
	@Test
	public void getOldHoaxesOfUser_whenUserExistAndThereAreHoaxes_receivePageWithHoaxVMBeforeProvideId() {
		User user = userService.save(TestUtil.createValidUser("user1"));
		hoaxService.save(user, TestUtil.createValidHoax());
		hoaxService.save(user, TestUtil.createValidHoax());
		hoaxService.save(user, TestUtil.createValidHoax());
		...
		ResponseEntity<TestPage<HoaxVM>> response = getOldHoaxesOfUser(fourthHoax.getId(), "user1",
				new ParameterizedTypeReference<TestPage<HoaxVM>>() {
				});
	...
	public void getOldHoaxesOfUser_whenUserExistAndThereAreNoHoaxes_receivePageWithZeroItemsBeforeProvidedId() {
		...
		ResponseEntity<TestPage<HoaxVM>> response = getOldHoaxesOfUser(fourthHoax.getId(), "user2",
				new ParameterizedTypeReference<TestPage<HoaxVM>>() {
				});
	...
	public void getNewHoaxes_whenThereAreHoaxes_receiveListOfItemsAfterProvidedId() {
		...
		ResponseEntity<List<Object>> response = getNewHoaxes(fourthHoax.getId(),
	...
	public void getNewHoaxes_whenThereAreHoaxes_receiveListOfHoaxVMAfterProvidedId() {
		...
		ResponseEntity<List<HoaxVM>> response = getNewHoaxes(fourthHoax.getId(),
	...
	@Test
	public void getNewHoaxesOfUser_whenUserExistAndThereAreHoaxes_receiveListWithItemsProvidedId() {
		User user = userService.save(TestUtil.createValidUser("user1"));
		hoaxService.save(user, TestUtil.createValidHoax());
		hoaxService.save(user, TestUtil.createValidHoax());
		hoaxService.save(user, TestUtil.createValidHoax());
		...
		ResponseEntity<List<Object>> response = getNewHoaxesOfUser(fourthHoax.getId(), "user1",
				new ParameterizedTypeReference<List<Object>>() {
				});
	...
	@Test
	public void getNewHoaxesOfUser_whenUserExistAndThereAreHoaxes_receiveListWithHoaxVMAfterProvideId() {
		User user = userService.save(TestUtil.createValidUser("user1"));
		hoaxService.save(user, TestUtil.createValidHoax());
		hoaxService.save(user, TestUtil.createValidHoax());
		hoaxService.save(user, TestUtil.createValidHoax());
		...
		ResponseEntity<List<HoaxVM>> response = getNewHoaxesOfUser(fourthHoax.getId(), "user1",
				new ParameterizedTypeReference<List<HoaxVM>>() {
				});
	...
	public void getNewHoaxesOfUser_whenUserExistAndThereAreNoHoaxes_receiveListWithZeroItemsAfterProvidedId() {
		...
		ResponseEntity<List<HoaxVM>> response = getNewHoaxesOfUser(fourthHoax.getId(), "user2",
				new ParameterizedTypeReference<List<HoaxVM>>() {
				});
	...
	public void getNewHoaxCount_whenThereAreHoaxes_receiveCountAfterProvidedId() {
		...
		ResponseEntity<Map<String, Long>> response = getNewHoaxCount(fourthHoax.getId(),
	...
	public void getNewHoaxCountOfUser_whenThereAreHoaxes_receiveCountAfterProvidedId() {
		...
		ResponseEntity<Map<String, Long>> response = getNewHoaxCountOfUser(fourthHoax.getId(), "user1",
				new ParameterizedTypeReference<Map<String, Long>>() {
				});
	...
	@Test
	public void deleteHoax_whenHoaxIsOwnedBynoterUser_receiveForbidden() {
		userService.save(TestUtil.createValidUser("user1"));
		authenticate("user1");
...
//Test Helper Methods
	...
	public <T> ResponseEntity<T> deleteHoax(long hoaxId, Class<T> responseType) {
		return testRestTemplate.exchange(API_V1_HOAXES + "/" + hoaxId, HttpMethod.DELETE, null, responseType);
	}

	public <T> ResponseEntity<T> getNewHoaxCount(long hoaxId, ParameterizedTypeReference<T> responseType) {
		String path = API_V1_HOAXES + "/" + hoaxId + "?direction=after&count=true";
		return testRestTemplate.exchange(path, HttpMethod.GET, null, responseType);
	}

	public <T> ResponseEntity<T> getNewHoaxCountOfUser(long hoaxId, String username,
			ParameterizedTypeReference<T> responseType) {
		String path = "/api/v1/users/" + username + "/hoaxes/" + hoaxId + "?direction=after&count=true";
		return testRestTemplate.exchange(path, HttpMethod.GET, null, responseType);
	}

	public <T> ResponseEntity<T> getNewHoaxesOfUser(long hoaxId, String username,
			ParameterizedTypeReference<T> responseType) {
	...
	public <T> ResponseEntity<T> getNewHoaxes(long hoaxId, ParameterizedTypeReference<T> responseType) {
		String path = API_V1_HOAXES + "/" + hoaxId + "?direction=after&sort=id,desc";
		return testRestTemplate.exchange(path, HttpMethod.GET, null, responseType);
	}

	public <T> ResponseEntity<T> getOldHoaxesOfUser(long hoaxId, String username,
			ParameterizedTypeReference<T> responseType) {
		String path = "/api/v1/users/" + username + "/hoaxes/" + hoaxId
	...
	public <T> ResponseEntity<T> getOldHoaxes(long hoaxId, ParameterizedTypeReference<T> responseType) {
		String path = API_V1_HOAXES + "/" + hoaxId + "?direction=before&page=0&size=5&sort=id,desc";
		return testRestTemplate.exchange(path, HttpMethod.GET, null, responseType);
	}
